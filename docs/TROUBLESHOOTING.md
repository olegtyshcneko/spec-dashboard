...
git rev-parse HEAD
codex plugin list --json
npx --yes --package=github:olegtyshcneko/spec-dashboard#v0.10.0 specdash --version
npx --yes --package=github:olegtyshcneko/spec-dashboard#v0.10.0 specdash validate --root . --json
```
