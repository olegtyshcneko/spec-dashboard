...
git rev-parse HEAD
codex plugin list --json
npx --yes --package=github:olegtyshcneko/spec-dashboard#v0.5.1 specdash --version
npx --yes --package=github:olegtyshcneko/spec-dashboard#v0.5.1 specdash validate --root . --json
```
